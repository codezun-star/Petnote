  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        ...
        // Backdrop fades independently of the panel's scale.
    ...
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          ...
          "max-h-[calc(100dvh-2rem)] overflow-y-auto rounded-xl border border-border bg-card p-6 shadow-xl",
          // Fade + scale in on open, fade + scale out on close.
